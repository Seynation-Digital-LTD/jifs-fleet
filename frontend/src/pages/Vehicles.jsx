...
const Vehicles = () => {
    ...
    const resetForm = () => {
        setFormData({ plate_no: '', vehicle_type: '', make_model: '', year: '', status: 'active' });
        setEditingId(null);
        setShowForm(false);
    };
                                    ...
                                    {isAdmin && (
                                        <td>
                                            <div className="flex items-center gap-3">
                                                <button onClick={() => handleEdit(vehicle)} className="link text-sm">
                                                    Edit
                                                </button>
                                                <button onClick={() => handleDelete(vehicle.id)} className="link link-danger text-sm">
                                                    Delete
                                                </button>
                                            </div>
                                        </td>
