...
const Login = () => {
    ...
    const bg = (
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-blue-600/5 blur-3xl"></div>
        </div>
    );
            ...
            <div className="w-full max-w-md relative animate-fade-in">
                <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/20 p-8 border border-white/20">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Jifs Company</h1>
                        <p className="text-gray-500 mt-1">Gen Supp Ltd — Fleet Management</p>
                    </div>

                    {/* First-time setup banner */}
                    {mode === 'setup' && (
                        <div className="mb-6 p-4 rounded-xl bg-blue-50 border border-blue-100 text-center">
                            <p className="text-blue-800 font-semibold text-sm">Welcome! First-Time Setup</p>
                            <p className="text-blue-600 text-xs mt-1">Create the main Admin account to get started.</p>
                        </div>
                    )}

                    {/* Error */}
                    {error && (
                        <div className="mb-5 p-4 rounded-xl bg-red-50 border border-red-100 flex items-center gap-3 animate-fade-in">
                    ...
                    {/* Success */}
                    {success && (
                        <div className="mb-5 p-4 rounded-xl bg-green-50 border border-green-100 flex items-center gap-3 animate-fade-in">
                    ...
                    {mode === 'login' && (
                        <form onSubmit={handleLogin} className="space-y-5">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" value={username} onChange={e => setUsername(e.target.value)}
                                        ...
                                        className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-gray-50 hover:bg-white"
                            ...
                            <button type="submit" disabled={loading}
                                className="w-full py-3.5 px-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-600/30 transition-all duration-200 disabled:opacity-50 flex items-center justify-center gap-2">
                                {loading ? (
                    ...
                    {mode === 'setup' && (
                        <form onSubmit={handleSetup} className="space-y-5">
                            ...
                            <div className="bg-amber-50 border border-amber-100 rounded-xl p-3 text-xs text-amber-700">
                                <strong>Write down your username and password</strong> and keep them safe. This is the main Admin account — if you forget it, you will not be able to access the system.
                            </div>
                            <button type="submit" disabled={loading}
                                className="w-full py-3.5 px-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 text-white font-semibold rounded-xl shadow-lg shadow-green-600/30 transition-all duration-200 disabled:opacity-50 flex items-center justify-center gap-2">
                                {loading ? (
